            ...
            <div class="row clearfix">
                <ul class="gallery-post-grid holder">
                    ...
                    <li  class="span2 gallery-item" data-id="id-1" data-type="illustration">
                        ...
                        <a href="gallery-single.php"><img src="img/gallery/gallery-img-1-6col.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.php">Custom Illustration</a>For an international add campaign.</span>
                    </li>

                    <!-- Gallery Item 2 -->
                    <li class="span2 gallery-item" data-id="id-2" data-type="illustration">
                        <span class="gallery-hover-6col hidden-phone hidden-tablet">
                            <span class="gallery-icons">
                                <a href="img/gallery/gallery-img-1-full.jpg" class="item-zoom-link lightbox" title="Custom Illustration" data-rel="prettyPhoto"></a>
                                <a href="gallery-single.php" class="item-details-link"></a>
                        ...
                        <a href="gallery-single.php"><img src="img/gallery/gallery-img-1-6col.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.php">3 Color Poster Design</a>For a regional festival event.</span>
                    </li>
                    ...
                    <li class="span2 gallery-item" data-id="id-3" data-type="web">
                        ...
                        <a href="gallery-single.php"><img src="img/gallery/gallery-img-1-6col.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.php">Ink Pen Illustration</a>Created for a best selling children's book.</span>
                    </li>

                    <!-- Gallery Item 4 -->
                    <li class="span2 gallery-item" data-id="id-4" data-type="video">
                        <span class="gallery-hover-6col hidden-phone hidden-tablet">
                            <span class="gallery-icons">
                                <a href="img/gallery/gallery-img-1-full.jpg" class="item-zoom-link lightbox" title="Custom Illustration" data-rel="prettyPhoto"></a>
                                <a href="gallery-single.php" class="item-details-link"></a>
                    ...
                    <!-- Gallery Item 5 -->
                    <li class="span2 gallery-item" data-id="id-5" data-type="web illustration">
                        <span class="gallery-hover-6col hidden-phone hidden-tablet">
                            <span class="gallery-icons">
                                <a href="img/gallery/gallery-img-1-full.jpg" class="item-zoom-link lightbox" title="Custom Illustration" data-rel="prettyPhoto"></a>
                                <a href="gallery-single.php" class="item-details-link"></a>
                        ...
                        <a href="gallery-single.php"><img src="img/gallery/gallery-img-1-6col.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.php">Icon Design</a>Classic retro style illustration.</span>
                    </li>

                    <!-- Gallery Item 6 -->
                    <li class="span2 gallery-item" data-id="id-6" data-type="illustration design">
                        <span class="gallery-hover-6col hidden-phone hidden-tablet">
                            <span class="gallery-icons">
                                <a href="img/gallery/gallery-img-1-full.jpg" class="item-zoom-link lightbox" title="Custom Illustration" data-rel="prettyPhoto"></a>
                                <a href="gallery-single.php" class="item-details-link"></a>
                        ...
                        <a href="gallery-single.php"><img src="img/gallery/gallery-img-1-6col.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.php">Animation Cell</a>Creative storyboard illustration</span>
                    </li>

                    <!-- Gallery Item 7 -->
                    <li class="span2 gallery-item" data-id="id-7" data-type="design">
                        <span class="gallery-hover-6col hidden-phone hidden-tablet">
                            <span class="gallery-icons">
                                <a href="img/gallery/gallery-img-1-full.jpg" class="item-zoom-link lightbox" title="Custom Illustration" data-rel="prettyPhoto"></a>
                                <a href="gallery-single.php" class="item-details-link"></a>
                        ...
                        <a href="gallery-single.php"><img src="img/gallery/gallery-img-1-6col.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.php">Poster Ad Campaign</a>Regional ad for a local company.</span>
                    </li>

                    <!-- Gallery Item 8 -->
                    <li class="span2 gallery-item" data-id="id-8" data-type="web video">
                        <span class="gallery-hover-6col hidden-phone hidden-tablet">
                            <span class="gallery-icons">
                                <a href="img/gallery/gallery-img-1-full.jpg" class="item-zoom-link lightbox" title="Custom Illustration" data-rel="prettyPhoto"></a>
                                <a href="gallery-single.php" class="item-details-link"></a>
                        ...
                        <a href="gallery-single.php"><img src="img/gallery/gallery-img-1-6col.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.php">Magazine Ad</a>For an international add campaign.</span>
                    </li>

                    <!-- Gallery Item 9 -->
                    <li class="span2 gallery-item" data-id="id-9" data-type="design">
                        <span class="gallery-hover-6col hidden-phone hidden-tablet">
                            <span class="gallery-icons">
                                <a href="img/gallery/gallery-img-1-full.jpg" class="item-zoom-link lightbox" title="Custom Illustration" data-rel="prettyPhoto"></a>
                                <a href="gallery-single.php" class="item-details-link"></a>
                        ...
                        <a href="gallery-single.php"><img src="img/gallery/gallery-img-1-6col.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.php">Character Designs</a>For a feature film and concert event.</span>
                    </li>

                    <!-- Gallery Item 10 -->
                    <li class="span2 gallery-item" data-id="id-10" data-type="web design">
                        <span class="gallery-hover-6col hidden-phone hidden-tablet">
                            <span class="gallery-icons">
                                <a href="img/gallery/gallery-img-1-full.jpg" class="item-zoom-link lightbox" title="Custom Illustration" data-rel="prettyPhoto"></a>
                                <a href="gallery-single.php" class="item-details-link"></a>
                        ...
                        <a href="gallery-single.php"><img src="img/gallery/gallery-img-1-6col.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.php">Poster and Ad Design</a>For an international add campaign.</span>
                    </li>

                    <!-- Gallery Item 11 -->
                    <li class="span2 gallery-item" data-id="id-11" data-type="illustration">
                        <span class="gallery-hover-6col hidden-phone hidden-tablet">
                            <span class="gallery-icons">
                                <a href="img/gallery/gallery-img-1-full.jpg" class="item-zoom-link lightbox" title="Custom Illustration" data-rel="prettyPhoto"></a>
                                <a href="gallery-single.php" class="item-details-link"></a>
                        ...
                        <a href="gallery-single.php"><img src="img/gallery/gallery-img-1-6col.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.php">Website and Animation</a>For a local business and trade show.</span>
                    </li>

                    <!-- Gallery Item 12 -->
                    <li class="span2 gallery-item" data-id="id-12" data-type="illustration video">
                        <span class="gallery-hover-6col hidden-phone hidden-tablet">
                            <span class="gallery-icons">
                                <a href="img/gallery/gallery-img-1-full.jpg" class="item-zoom-link lightbox" title="Custom Illustration" data-rel="prettyPhoto"></a>
                                <a href="gallery-single.php" class="item-details-link"></a>
                        ...
                        <a href="gallery-single.php"><img src="img/gallery/gallery-img-1-6col.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.php">Branding Design</a>For an international add campaign.</span>
                    </li>
