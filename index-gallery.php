        ...
        ================================================== -->
            ...
            <ul class="gallery-post-grid holder">
                    ...
                    <li  class="span3 gallery-item" data-id="id-1" data-type="illustration">
                        ...
                        <a href="gallery-single.php"><img src="img/gallery/gallery-img-1-4col.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.php">Custom Illustration</a>For an international ad campaign.</span>
                    </li>
                    ...
                    <li class="span3 gallery-item" data-id="id-9" data-type="design">
                        ...
                        <a href="gallery-single.php"><img src="img/gallery/gallery-img-1-4col.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.php">Character Designs</a>For a feature film.</span>
                    </li>
                    ...
                    <li class="span3 gallery-item" data-id="id-11" data-type="illustration">
                        ...
                        <a href="gallery-single.php"><img src="img/gallery/gallery-img-1-4col.jpg" alt="Gallery"></a>
                        <span class="project-details"><a href="gallery-single.php">Website and Animation</a>For a local business.</span>
                    </li>
    ...
    <div class="row"><!-- Begin Bottom Section -->
        ...
        <div id="blogCarousel" class="carousel slide ">
            ...
            <div class="carousel-inner">
                ...
                <div class="active item">
                    <a href="blog-single.php"><img src="img/gallery/blog-med-img-1.jpg" alt="" class="align-left blog-thumb-preview" /></a>
                    <div class="post-info clearfix">
                        <h4><a href="blog-single.php">A subject that is beautiful in itself</a></h4>
                    ...
                    <p class="blog-summary"> <a href="#">Read more</a><p>
                </div>
                ...
                <!-- Blog Item 2 -->
                 <div class="item">
                    <a href="blog-single.php"><img src="img/gallery/blog-med-img-1.jpg" alt="" class="align-left blog-thumb-preview" /></a>
                    <div class="post-info clearfix">
                        <h4><a href="blog-single.php">A great artist is always before his time</a></h4>
                        <ul class="blog-details-preview">
                            <li><i class="icon-calendar"></i><strong>Posted on:</strong> Sept 4, 2015<li>
                            <li><i class="icon-user"></i><strong>Posted by:</strong> <a href="#" title="Link">Admin</a><li>
                            <li><i class="icon-comment"></i><strong>Comments:</strong> <a href="#" title="Link">12</a><li>
                 ...
                 <div class="item">
                    ...
                    <div class="post-info clearfix">
                        ...
                        <ul class="blog-details-preview">
                            <li><i class="icon-calendar"></i><strong>Posted on:</strong> May 24, 2017<li>
                            <li><i class="icon-user"></i><strong>Posted by:</strong> <a href="#" title="Link">Admin</a><li>
                            <li><i class="icon-comment"></i><strong>Comments:</strong> <a href="#" title="Link">12</a><li>
                            <li><i class="icon-tags"></i> <a href="#">photoshop</a>, <a href="#">tutorials</a>, <a href="#">illustration</a>
                        </ul>
        ...
        <div class="span6">
            ...
            <div class="carousel-inner">
                ...
                <div class="active item">
                    <p class="quote-text">""<cite>- Client Name, Big Company</cite></p>
                </div>

                <div class="item">
                    <p class="quote-text">""<cite>- Another Client Name, Company Name</cite></p>
                </div>

                <div class="item">
                    <p class="quote-text">""<cite>- On More Client, The Company</cite></p>
                </div>
