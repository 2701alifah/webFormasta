...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?php echo base_url()?>assets/admin/js/sb-admin-2.css" rel="stylesheet">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="POST" enctype="multipart/form-data" action="<?php echo base_url()."index.php/MyControllerAdmin/do_insert/";?>">
                                        <table>
                                        <tr>
                                        ...
                                        <tr>
                                         ...
                                         <td><input type="text" name="teks_artikel" style="height: 40px;"><br/></td>
                                        </tr>
                                         <tr>
                                                <td></td>
